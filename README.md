...
| 5 | [wpre](https://github.com/coff33ninja/wpre) | Windows Profile Reconstruction Engine — deterministic multi-stage pipeline for harvesting user data and rebuilding clean local Windows profiles. Single Go binary with embedded PowerShell and Python modules. | Go | 2026-06-09 |
| 6 | [it-bible](https://github.com/coff33ninja/it-bible) | 40 books, 267 warnings of IT suffering. A living collection of user error scenarios and IT support trauma. | HTML | 2026-06-04 |
| 7 | [ytdlp-desktop](https://github.com/coff33ninja/ytdlp-desktop) | Native Windows desktop GUI for yt-dlp. Download YouTube/video URLs with format selection, probe available qualities, presets, history, and a compact floating widget. Single static EXE, no Python runtime. | Go | 2026-05-28 |
| 8 | [ai-skills](https://github.com/coff33ninja/ai-skills) | — | Python | 2026-05-25 |
...
1. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
2. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
3. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
4. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
5. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
6. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
7. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
8. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
9. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
10. 🚀 Pushed to [coff33ninja/tailscale-manager](https://github.com/coff33ninja/tailscale-manager)
